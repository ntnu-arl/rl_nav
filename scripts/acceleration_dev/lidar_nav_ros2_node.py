...
class LidarNavigationNode(Node):
    ...
    def pointcloud_callback(self, msg):
        ...
        # save as plt image before and after downsampling
        # import matplotlib.pyplot as plt
        # imsave
        # plt.imsave("lidar_before_downsampling.png", bins.T.cpu().numpy(), vmin=0, vmax=cfg.LIDAR_MAX_RANGE)
        # plt.imsave("lidar_after_downsampling.png", bins_downsampled.squeeze().cpu().numpy(), vmin=0, vmax=cfg.LIDAR_MAX_RANGE)
